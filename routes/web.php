...
Route::group(['middleware'=>'auth'], function(){
    ...
    Route::get('/confirm-password', 'Auth\ForgotPasswordController@ForgotPassword')->name('password.request');
    Route::get('/reset-password', 'Auth\ForgotPasswordController@EmailForm')->name('password.emailForm');
    Route::get('/password/reset/{token}','Auth\ForgotPasswordController@PasswordResetForm')->name('password.reset');

    Route::post('/reset-password','Auth\ForgotPasswordController@PasswordUpdate')->name('password.update');
