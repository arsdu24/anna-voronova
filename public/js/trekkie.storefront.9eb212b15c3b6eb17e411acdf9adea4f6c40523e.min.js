! function() {
    ...
    var e = {
            ...
            7385: function(e, t, n) {
                ...
                var v = function(e) {
                    ...
                    return o(t, e), t.prototype.ensureTrackingConsent = function(e, t) {
                        ...
                        if (this.appName && this.appName in u.appNameToEcommerceEventSchemaId) {
                            var t = this.getEcommercePixelIds();
                            i.addBatchEvent({
                                schemaId: e.schemaId ? e.schemaId : u.appNameToEcommerceEventSchemaId[this.appName],
                            ...
                            }), e.eventName in u.ecommerceEventNameSchemaId && i.addBatchEvent({
                                schemaId: u.ecommerceEventNameSchemaId[e.eventName],
                                payload: {
                                    shop_id: this.shopId,
                                    partner_name: this.getEcommerceMetricsTag()
                                }
            ...
            1930: function(e, t) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.extractSchemaIdFromEventName = t.trekkieAssetContextSchemaId = t.customerEventSchemaId = t.ecommerceEventNameSchemaId = t.eventParityTestingSchemaId = t.appNameToEcommerceEventSchemaId = t.appNameToPageViewSchemaId = void 0, t.appNameToPageViewSchemaId = {
                ...
                }, t.eventParityTestingSchemaId = "trekkie_integration_parity_event_emit/2.0", t.ecommerceEventNameSchemaId = {
                ...
                }, t.customerEventSchemaId = "trekkie_customer_events/2.0", t.trekkieAssetContextSchemaId = "trekkie_asset_context/1.1", t.extractSchemaIdFromEventName = function(e) {
                    var t = "monorail://",
                        n = e.toLowerCase();
            ...
            7265: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.CustomerEvents = void 0;
                var i = n(7385),
                    a = n(8288),
                    c = function(e) {
                        function t(t, n, r) {
                            var o = e.call(this, {}, t, n.defaultAttributes) || this;
                            return window.Shopify.events = new a.CustomerEventsSubject, r(), o
                        }
                        return o(t, e), t.prototype.isEssential = function() {
                            ...
                            window.Shopify.events.dispatchEvent("PageView", e)
                        }, t.prototype.track = function(e) {}, t.prototype.viewedProductCategory = function(e) {
                            window.Shopify.events.dispatchEvent("ViewedProductCategory", e)
                        }, t.prototype.viewedProductVariant = function(e) {
                            window.Shopify.events.dispatchEvent("ViewedProductVariant", e)
                        }, t.prototype.viewedProduct = function(e) {
                            window.Shopify.events.dispatchEvent("ViewedProduct", e)
                        }, t.prototype.addedProduct = function(e) {
                            window.Shopify.events.dispatchEvent("AddedProduct", e)
                        }, t.prototype.addedPayment = function(e) {
                            window.Shopify.events.dispatchEvent("AddedPayment", e)
                        }, t.prototype.performedSearch = function(e) {
                            window.Shopify.events.dispatchEvent("PerformedSearch", e)
                        }, t.prototype.startedOrder = function(e) {
                            window.Shopify.events.dispatchEvent("StartedOrder", e)
                        }, t.prototype.completedOrder = function(e) {
                            window.Shopify.events.dispatchEvent("CompletedOrder", e)
                        }, t.prototype.getEcommerceMetricsTag = function() {
                            return "customer-events-api"
                ...
                var a = n(7385),
                    ...
                    h = function(e) {
                        function t(n, r, o) {
                            ...
                            return a.campaignManager = new f.CampaignManager, e.prototype.ensureTrackingConsent.call(a, (function() {
                                a.initialize(o)
                            }), o), a
                        }
                        return o(t, e), t.prototype.isEssential = function() {
                            ...
                            if (this.options.conversionsAPIEnabled && t.customerApiData) {
                                ...
                                u.produce([d]), this.emitEvent("Purchase", e.eventId, a.ANALYTICS_COMPLETED_ORDER, n)
                            } else this.emitEvent("Purchase", e.eventId, a.ANALYTICS_COMPLETED_ORDER, n)
                        }, t.prototype.emitEvent = function(e, t, n, r) {
                            !0 !== this.options.disablePartnerCommunication && (r ? window.fbq("track", e, r, {
                                eventID: t
                            }) : window.fbq("track", e, {
                                eventID: t
                                ...
                                schemaId: v.eventParityTestingSchemaId,
                                payload: d.objectAssignFilterUndefined({
                                    event_id: t,
                                    event_name: n,
                                    shop_id: this.shopId,
                                    integration_id: this.getIntegrationId(),
                                    ...
                                    event_properties: r ? JSON.stringify(r) : void 0
                                })
                            })
                        }, t.prototype.setLimitedDataUseMode = function() {
                            this.isPartnerCommunicationDisabled() || window.fbq("dataProcessingOptions", ["LDU"], 1, 1e3)
                        }, t.prototype.initialize = function(e) {
                            if (!this.isPartnerCommunicationDisabled()) {
                            ...
                            if (!(this.isPartnerCommunicationDisabled() || window.fbq && "function" == typeof window.fbq)) {
                                window.fbq = function() {
                        ...
                        }, t.prototype.isPartnerCommunicationDisabled = function() {
                            return !0 === this.options.disablePartnerCommunication
                        }, t.defaultOptions = {
                            pixelId: "",
                            pixelIds: [],
                            agent: "shopify",
                    ...
                    p = function(e) {
                        ...
                        return o(t, e), t.prototype.identify = function(e) {
                            ...
                            if (r) {
                                ...
                                for (var c = [], s = 0, p = o; s < p.length; s++) {
                                    var u = p[s],
                            ...
                            for (var r = [], o = 0, i = n; o < i.length; o++) {
                                var c = i[o],
                                    ...
                                    p = this.enhancedEcommerceTrackProduct(s);
                                r.push(p)
                            }
                            var u = t.step || 1;
                            ...
                            if (r) {
                                ...
                                for (var i = [], c = 0, s = o; c < s.length; c++) {
                                    var p = s[c],
                                        u = this.createProductTrack(t, p),
                                        d = this.enhancedEcommerceTrackProduct(u);
                                    i.push(d)
                                }
                                var v = {
                                    id: r,
            ...
            4922: function(e, t, n) {
                ...
                var i = n(7385),
                    ...
                    u = function(e) {
                        ...
                        return o(t, e), t.prototype.identify = function(e) {}, t.prototype.track = function(e) {}, t.prototype.page = function(e) {}, t.prototype.onPageView = function(e) {
                            var t = e.properties;
                            ...
                            !0 !== this.options.disablePartnerCommunication && (window.pintrk("track", e, Object.assign({
                                np: "shopify"
                            }, r)), this.addMonorailBatchEvent(p.objectAssignFilterUndefined({
                                eventName: n
                            }, {
                                eventId: t,
                                eventProperties: r ? JSON.stringify(r) : void 0
                            }))), s.addBatchEvent({
                                schemaId: c.eventParityTestingSchemaId,
                            ...
                            var t = this.options;
                            !0 !== t.disablePartnerCommunication && (this.loadPinterestScript(), window.pintrk("load", t.pixelId, {
                                np: "shopify"
                        ...
                        }, t.prototype.onAddedPayment = function(e) {}, t.prototype.onViewedProductVariant = function(e) {}, t.prototype.onStartedOrder = function(e) {}, t.defaultOptions = {
                            pixelId: "",
                            disablePartnerCommunication: !1
                        }, t
                    }(a.CustomerEventsObserver);
                t.PinterestCEJI = u
            },
            8142: function(e, t, n) {
                var r, o = this && this.__extends || (r = function(e, t) {
                    ...
                    return o(n, e), n.prototype.isEssential = function() {
                        ...
                        if (this.timestampManager.isValid(e) && this.campaignManager.isValid(r));
                            ...
                            this.track({
                                ...
                                properties: {
                                    sa_url: s.href(),
                                    sa_referrer: p.virtualDocument().referrer(),
                                    sa_utm_string: r,
                ...
                var i = n(7385),
                    ...
                    u = function(e) {
                        ...
                        return o(t, e), t.prototype.isEssential = function() {
                            ...
                            this.emitEvent("PAGE_VIEW", null == e ? void 0 : e.eventId, i.ANALYTICS_PAGE_VIEW, {
                            ...
                            var t = e.properties,
                                n = p.objectAssignFilterUndefined({
                                    item_ids: this.getOrderContentIds(t),
                                    item_type: this.getOrderContentType(t),
                                    currency: this.getCurrency(t.currency),
                            ...
                            if (!(this.isPartnerCommunicationDisabled() || window.snaptr && "function" == typeof window.snaptr)) {
                            ...
                            this.isPartnerCommunicationDisabled() || (window.snaptr("track", e, Object.assign({
                                integration: "shopify-native"
                            }, r)), this.addMonorailBatchEvent(p.objectAssignFilterUndefined({
                                eventName: n
                            }, {
                        ...
                        return o(t, e), t.prototype.isEssential = function() {
                            ...
                            if (!window.ttq || !window.ttq.loaded) {
                                ...
                                t.instance = function(e) {
                                    ...
                                    t._i = t._i || {}, t._i[e] = [], t._i[e]._u = n, t._t = t._t || {}, t._t[e] = +new Date, t._o = t._o || {}, t._partner = t._partner || "Shopify";
                ...
                var a = n(372),
                    ...
                    v = function(e) {
                        ...
                        return o(t, e), t.prototype.isEssential = function() {
                            ...
                            var n = "global";
                            e.monorailRegion && (n = e.monorailRegion), e.development && (n = "staging"), p.setMonorailRegion(n), window.addEventListener("beforeunload", (function(e) {
                                p.flushBatchEvents()
                            })), e.defaultAttributes && u.setMetricsOptions(e.defaultAttributes.shopId);
                            var r = !1;
            ...
            6997: function(e, t, n) {
                ...
                function v() {
                    if (void 0 === r)
                        if (h()) r = p.hostname();
                            ...
                            for (var e = "", n = 0, o = p.hostname().split(".").reverse(); n < o.length; n++) {
                                var i = o[n];
                                e = "" === e ? "." + i : "." + i + e;
                                var a = u.generateShopifyDValue();
                                if (f(d, a, 0, e), c = d, s = a, v = void 0, (v = t.cookieImpl.read(c)) && v === s) return f(d, a, -1, e), void(r = e)
                            }
                            r = ""
                        }
                    var c, s, v
                ...
                function h() {
                    return -1 !== p.hostname().indexOf("myshopify.com")
                }
                t.cookieImpl = {
                        parse: function(e) {
                        ...
                        write: function(e, n, r) {
                            if (void 0 === r && (r = {}), t.cookieImpl.enabled() && t.cookieImpl.allowed()) {
                                ...
                                r.maxage && (r.expires = new Date((new Date).getTime() + r.maxage)), r.path && (o += "; path=" + r.path), r.domain && (o += "; domain=" + r.domain), r.expires && t.cookieImpl.hasConsent() && (o += "; expires=" + r.expires.toUTCString()), r.samesite ? o += "; SameSite=" + r.samesite : o += "; SameSite=Lax", r.secure && (o += "; secure"), c.virtualDocument().setCookie(o)
                            }
                        },
                        enabled: function(e) {
                        ...
                        void 0 === o && (o = "Lax"), v(), f(e, t, n ? 31104e6 : 18e5, r, o)
                    }, t.clear = function(e) {
                        v(), f(e, "", -1, r)
                    ...
                    function(e) {
                        ...
                        haveConsentToTrack: function() {
                            ...
                            if (!e.lim.includes(a.GDPR)) return !0;
                            var n = e.con.GDPR,
                                r = e.reg;
                        ...
                        haveConsentToSellData: function() {
                            ...
                            if (e.lim.includes(a.CCPA_BLOCK_ALL)) return !1;
                            var n = e.con.CCPA;
            ...
            8288: function(e, t) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.CustomerEventsSubject = void 0;
                var n = function() {
                    function e(e) {
                        void 0 === e && (e = new Set), this.eventToMethodMapping = {
                            PageView: "onPageView",
                            ViewedProductCategory: "onViewedProductCategory",
                            ViewedProductVariant: "onViewedProductVariant",
                            ViewedProduct: "onViewedProduct",
                            AddedProduct: "onAddedProduct",
                            AddedPayment: "onAddedPayment",
                            PerformedSearch: "onPerformedSearch",
                            StartedOrder: "onStartedOrder",
                            CompletedOrder: "onCompletedOrder"
                        }, this.observers = e
                    }
                    return e.prototype.subscribe = function(e) {
                        ...
                        var n = this;
                        this.observers.forEach((function(r, o, i) {
                            try {
                                var a = n.eventToMethodMapping[e];
                                r[a] && "function" == typeof r[a] && r[a].call(r, t)
                            } catch (e) {}
                        }))
                    }, e
                }();
                t.CustomerEventsSubject = n
            },
            725: function(e, t, n) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/1.0", t.errorsSchemaId = "trekkie_errors/1.0", t.setMetricsOptions = function(e) {
                    ...
                    try {
                        ...
                        r && (a.shop_id = r), n && (a.metadata = n), o.produce([{
            ...
            997: function(e, t) {
                ...
                function i(e, t) {
                    ...
                    try {
                        r.open("POST", e), r.setRequestHeader("Content-Type", "text/plain"), r.send(t)
                    } catch (e) {
                        console.log(e)
                    }
                    return !1
            ...
            7668: function(e, t, n) {
                ...
                var r = n(7e3),
                    o = n(6997),
                    i = n(2971);
                t.deprecatedShortTermKey = "_s", t.shortTermKey = "_shopify_s", t.deprecatedLongTermKey = "_y", t.longTermKey = "_shopify_y", t.firstSeenKey = "_shopify_fs";
                    ...
                    c = function() {
                        ...
                        return e.prototype.fetchOrSet = function(e, t, n, r) {
                            ...
                            var a = o.read(n) || o.read(t),
                                c = !r;
                            a || (a = p(), c = !0, r && i.emitMetric("serverSideCookieNotSet_" + n, 1)), c && (o.write(t, a, e), o.write(n, a, e));
                            var s = o.read(n) || o.read(t);
                ...
                var s = function() {
                    function e() {}
                    return e.prototype.fetchOrSet = function(e) {
                        var t = o.read(e) || (new Date).toJSON();
                ...
                t.FirstSeenManager = s, t.buildToken = p, t.hexTime = u
            },
            1102: function(e, t) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            5316: function(e, t, n) {
                var r = n(9426),
                    ...
                    i = [],
                    a = n(7265);
                i.push(["Customer Events API", a.CustomerEvents]);
                var c = n(8878);
                i.push(["Facebook Pixel", c.FacebookPixel]);
                var s = n(7575);
                i.push(["Google Analytics", s.GoogleAnalytics]);
                var p = n(8142);
                i.push(["Pinterest Pixel", p.Pinterest]);
                var u = n(6971);
                i.push(["Snap Pixel", u.Snap]);
                var d = n(342);
                i.push(["TikTok Pixel", d.TikTok]);
                var v = n(2724);
                i.push(["Session Attribution", v.SessionAttribution]);
                var f = n(5087);
                i.push(["Google Gtag Pixel", f.GoogleGtag]);
                var h = n(4922);
                i.push(["Pinterest CEJI Pixel", h.PinterestCEJI]);
                try {
                    var l = window.trekkie.config;
                    if (l) {
                        o.setGlobalSerializedAppConfig(JSON.stringify(l));
                        var m = window.trekkie,
                            y = window.trekkie = new r.Tricorder(i, l, (function() {
            ...
            9426: function(e, t, n) {
                ...
                var r = n(8831),
                    ...
                    h = function() {
                        function e(e, t, n) {
                            var r = this;
                            this.integrations = [];
                            var o = t.Trekkie.isPixelGateEnabled;
                            this.logAssetContext(t), o && this.hasLoadFeatureScript() && window.Shopify && window.Shopify.loadFeatures ? window.Shopify.loadFeatures([{
                        ...
                        return e.prototype.logAssetContext = function(e) {
                            ...
                            c.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "9eb212b15c3b6eb17e411acdf9adea4f6c40523e",
                            ...
                            for (var i = this.waitFor(e.length, (function() {
                                ...
                                try {
                                    ...
                                    if (u && "object" == typeof u) {
                                        var v = new(0, p[1])(u, n, i);
                                        this.integrations.push(v), v instanceof d.CustomerEventsObserver && window.Shopify && window.Shopify.events && window.Shopify.events.subscribe(v)
                                    } else i()
                                } catch (e) {
                                    i(), o.internalError(e)
                                }
                            ...
                            void 0 === e && (e = ""), void 0 === t && (t = {}), n = n || u.buildToken(), e instanceof Object && (t = e, e = "");
                            ...
                            for (var i = 0, a = this.integrations; i < a.length; i++) {
                                var c = a[i];
                                try {
                                    !c.isEssential() && p.privacyApiMethods.hasCustomerPrivacyAPI() || c.page(this.generatePageObject(e, t, n))
                                } catch (e) {
                                    o.internalError(e)
                                }
                            }
                            p.privacyApiMethods.hasCustomerPrivacyAPI() && (p.privacyApiMethods.userCanBeTracked() ? this.gatedPage(e, t, n) : document.addEventListener(s.TrackingConsentEvents.TRACKING_ACCEPTED, (function() {
                                r.gatedPage(e, t, n)
                            })))
                            ...
                            for (var i = 0, a = this.integrations; i < a.length; i++) {
                                var c = a[i];
                                try {
                                    !c.isEssential() && p.privacyApiMethods.hasCustomerPrivacyAPI() || c.track({
                                        event: e,
                                        properties: t,
                                        eventId: n
                                    })
                            ...
                            p.privacyApiMethods.hasCustomerPrivacyAPI() && (p.privacyApiMethods.userCanBeTracked() ? this.gatedTrack(e, t, n) : document.addEventListener(s.TrackingConsentEvents.TRACKING_ACCEPTED, (function() {
                                r.gatedTrack(e, t, n)
                            })))
                ...
                t.Tricorder = h, t.replayAnalyticsQueue = function(e, t) {
