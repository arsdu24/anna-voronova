      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item ">Shipping Details</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<div class="col-12 col-lg-12">
    <div class="card ">
      ...
      <div class="card-body">
        ...
        @if(count($details)!=0)
          <table class="table table-borderless table-striped table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
          <thead>
          <tr role="row">
              <th>Icon</th>
              <th>Title</th>
          ...
          <tbody>
              ...
              <tr class="odd">
                  <td tabindex="0">
                    <i class="{{$detail->icon}}" style="color:rgb(70, 70, 70);font-size:48px"></i>
                  </td>
                  <td>{{$detail->title}}</td>
                  <td>{{$detail->subtitle}}</td>
                  <td>
                    <button type="button" class="btn btn-info btn-md col-6" data-toggle="modal" data-target="#icon-{{$detail->id}}">
                        Edit
                    </button>
                  </td>
                </tr>
                <div id="icon-{{$detail->id}}" class="modal fade" role="dialog">
                      ...
                      <div class="modal-body">
                          <form method="POST" action="{{ route('shippingDetailsEdit',['ShippingDetail'=>$detail])}}" enctype="multipart/form-data" >
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-6">
                                      <button type="button" class="btn btn-primary btn-md col-12" data-toggle="modal" data-target="#iconList">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-6">
                                      <input id="title" type="text" class="form-control " maxlength="100" name="title" value="{{$detail->title ?? ''}}" required autocomplete="title">
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label for="subtitle" class="col-md-4 col-form-label text-md-right">Subtitle</label>
                                  <div class="col-md-6">
                                      <input id="subtitle" type="text" class="form-control" maxlength="200" name="subtitle" value="{{$detail->subtitle ?? ''}}"  required autocomplete="subtitle">
                                  </div>
                              </div>
                              <div class="form-group row">
      ...
      @endif
        ...
        <div id="iconList" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Chose Icon</h4>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class=" modal-footer ">
                    <button type="button" data-dismiss="modal" id="closeModal" class="btn btn-secondary btn-sm">
                        {{ __('Close') }}
                    </button>
                </div>
              </div>
...
@section('scripts')
    ...
    $('.icon-div i').click(function(){
        ...
        $('.show').find('#iconPreview').attr('class',icon);
    })
</script>
@endsection