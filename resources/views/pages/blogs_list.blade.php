...
<section class="content-header">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <button type="button" class="btn col-md-3 col-12 ml-3 p-0" >
        ...
        <button type="button" class=" card-tools btn btn-info btn-md col-md-2 col-12 float-md-right float-none ml-3" data-toggle="modal" data-target="#myModal">
            <i class="fas fa-plus"></i>
           Write an article
        </button>
      </div>
  ...
  <div class="col-sm-12 col-md-5">
    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">
       Showing {{$articles->firstItem()  ?? '0'}} to {{$articles->lastItem()}} of {{$articles->total()}} entries
    </div>
  </div>
