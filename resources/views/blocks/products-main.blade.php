                    ...
                    <ul class="sidebarListCategories list-unstyled">
                                @if(!isset($category) )
                                 <li class="sidebarCateItem active">
                                  <a class="active" @if(isset($collection)) href ="/collections/{{$collection->id}}"
                                                    @else href="/products" @endif>All Categories</a></li>
                                @else
                                    <li class="sidebarCateItem">
                                    <a @if(isset($collection)) href ="/collections/{{$collection->id}}"
                                       @else href="/products" @endif>All Categories</a></li>
                                @endif
    ...
    <li class="filterItem active"  data-filter="price_-150-200" data-filter="price_-150-200">
        ...
        <li class="filterItem" data-filter="price_-200-250">
            <a href="/collections/all/price_-200-250" title="Narrow selection to products matching tag Price_ $0 - $50"> $200 - $250</a>
                                              ...
                                              @endif
        @if(isset($_GET['constraint']) && strpos($_GET['constraint'], 'price_->250')!==false)
            <li class="filterItem active" data-filter="price_->250">
                <a href="price_->250?view=list" title="Narrow selection to products matching tag Price_ > $250"> bigger then $250 </a>
            </li>
        @else
            <li class="filterItem" data-filter="price_->250">
                <a href="price_->250?view=list" title="Narrow selection to products matching tag Price_ > $250"> > $250 </a>
            </li>
        @endif
                    </ul>
                    </div>
